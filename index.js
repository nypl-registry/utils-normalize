...
exports.percentOverlap = function (source, compare) {
  if (source.split(' ').length < 3 || compare.split(' ').length < 3) return 0

  var baseLine = overlap(source, source, {
    ignoreCase: true,
    minWordLength: 2,
  ...
  var results = overlap(source, compare, {
    ignoreCase: true,
    minWordLength: 2,
    ignoreCommonWords: true,
    depluralize: true
